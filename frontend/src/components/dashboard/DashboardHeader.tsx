    ...
    <div className="flex flex-col gap-4 border-b border-slate-800/80 pb-6 md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Real-time cyber defense telemetry, camera surveillance & MTD dynamic threat response.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="hidden items-center gap-2 rounded-lg border border-slate-800 bg-slate-900/90 px-3 py-1.5 text-xs text-slate-300 sm:flex">
          ...
          <span>MTD Defense: <strong className="text-emerald-400">ACTIVE</strong></span>
        </div>
        ...
        <div className="relative flex-1 sm:w-64 sm:flex-initial">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-800 bg-slate-900/90 py-1.5 pl-9 pr-3 text-xs text-white placeholder-slate-500 focus:border-cyan-500 focus:outline-none"
          />
        </div>
